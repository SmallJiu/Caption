...
public class RightUpCornerToLeftDownCornerStyle extends DisplayStyle {
	public static final RightUpCornerToLeftDownCornerStyle instance = new RightUpCornerToLeftDownCornerStyle();
	private RightUpCornerToLeftDownCornerStyle() {
		super(6, DisplaySideType.DOWN, DisplaySideType.LEFT);
	}
	protected RightUpCornerToLeftDownCornerStyle(DisplaySideType... sides) {
		super(sides);
	}
	@Override

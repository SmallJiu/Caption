...
*/
	...
	public void changeTo(ICaption other) {
		this.displayName = other.getDisplayName();
		this.displayText = other.getDisplayText();
		this.side = other.getDisplaySide();
		this.needBg = other.isNeedBackground();
		this.displayTime.add(other.getTalkTime());
	}

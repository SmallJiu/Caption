...
public interface ISound extends ISerializable {
	...
	public static class Builder {
		...
		@ZenMethod("pos")
		public Builder setPlayPosition(Pos playPosition) {
			this.playPosition = playPosition.toBlockPos();
			return this;
		}
		@ZenMethod("pos")
		public Builder setPlayPosition(int x, int y, int z) {
			this.playPosition = new BlockPos(x, y, z);
			return this;
		}
